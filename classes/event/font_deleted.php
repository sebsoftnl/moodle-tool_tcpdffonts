...
/**
 * The tool_tcpdffonts font_deleted event.
 *
 * File         font_deleted.php
 * Encoding     UTF-8
 *
...
class font_deleted extends base {
     ...
     */
    const EVT_NAME = 'fontdeleted';
    /**
     * Event action. Reflects the type of action performed (usually deleted, read, updated, deleted).
     */
    const EVT_ACTION = 'deleted';
